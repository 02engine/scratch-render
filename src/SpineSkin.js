...
class SpineSkin extends Skin {
    constructor (id, spineManager, renderer) {
        super(id, renderer);
        ...
        if (this._renderer && this._renderer.gl) {
            this._texture = this._renderer.gl.createTexture();
        }
    }
    ...
    dispose () {
        ...
        if (this._texture && this._renderer && this._renderer.gl) {
    ...
    render (drawable, drawableScale, projection, opts){
        ...
        if (skeleton && animationState) {
            if (this._renderer && typeof this._renderer.requestRenderSkeleton === 'function') {
                this._renderer.requestRenderSkeleton();
            }
